/* ===================================================================
   ...
   stops being a challenge and starts being a wall. 6 out of 8 says
   "you understand this" without demanding you be flawless.
    ...
    questions: [
      {
        ...
        answer: 1,
        why: "Venus — even though Mercury sits closer to the Sun. Venus's thick carbon-dioxide atmosphere traps heat, holding the surface near 465 °C day and night."
      },
      {
        q: "How long does sunlight take to reach Earth?",
        options: ["8 seconds", "8 minutes 20 seconds", "8 hours", "Instantly"],
        answer: 1,
        why: "About 8 minutes 20 seconds. If the Sun vanished right now, we would not know for over eight minutes."
      },
      {
        q: "Which is the largest planet in the solar system?",
        options: ["Saturn", "Neptune", "Jupiter", "Uranus"],
        answer: 2,
        why: "Jupiter. It is so large that every other planet in the solar system would fit inside it with room to spare."
      },
      {
        q: "Which planet is famous for its bright ring system?",
        options: ["Jupiter", "Saturn", "Mars", "Venus"],
        answer: 1,
        why: "Saturn. All four giant planets have rings, but Saturn's are by far the brightest — mostly chunks of water ice."
      },
      {
        q: "What is the closest star to Earth?",
        options: ["Sirius", "Proxima Centauri", "Polaris", "The Sun"],
        answer: 3,
        why: "The Sun. It is easy to forget the Sun is a star at all — it just happens to be extremely close. Proxima Centauri is the closest one after it."
      },
      {
        q: "What is the Milky Way?",
        options: [
          "A cloud of gas inside the solar system",
          "The galaxy our solar system lives in",
          "Another name for the Andromeda galaxy",
          "The band of planets around the Sun"
        ],
        answer: 1,
        why: "Our galaxy. When you see that pale band across a dark sky, you are looking edge-on through the disc of the galaxy you live in."
      },
      {
        q: "Why can't sound travel through space?",
        options: [
          "Space is too cold",
          "There is almost no matter for the sound to travel through",
          "Sound moves too slowly to cross the distance",
          "Gravity absorbs the sound"
        ],
        answer: 1,
        why: "Sound is a vibration passed from particle to particle. Space is very nearly empty, so there is nothing to pass the vibration along."
      },
      {
        q: "Roughly how long does the Moon take to orbit the Earth?",
    ...
    questions: [
      {
        ...
        answer: 2,
        why: "Distance — how far light travels in one year, about 9.46 trillion km. The word 'year' in it fools almost everyone the first time."
      },
      {
        q: "Why do we always see the same side of the Moon?",
        options: [
          "The Moon does not rotate at all",
          "The Moon rotates exactly once per orbit — it is tidally locked",
          "The far side is always in shadow",
          "The Earth's atmosphere hides the other side"
        ],
        answer: 1,
        why: "It is tidally locked: one rotation per orbit. The Moon does spin — it just spins at exactly the rate that keeps one face towards us."
      },
      {
        q: "Roughly how old is the universe?",
        options: ["4.5 billion years", "13.8 billion years", "100 billion years", "500 million years"],
        answer: 1,
        why: "About 13.8 billion years. Earth is much younger at roughly 4.5 billion — our planet has only been here for the last third of the story."
      },
      {
        q: "What is the brightest star in Earth's night sky?",
        options: ["Polaris", "Betelgeuse", "Sirius", "Vega"],
        answer: 2,
        why: "Sirius, in Canis Major. Polaris is famous for sitting almost due north, not for being bright — it is only the 48th brightest."
      },
      {
        ...
        options: [
          ...
          "One light-year divided by a thousand"
        ],
        answer: 1,
        why: "The average Earth–Sun distance, about 150 million km. It is a handy ruler for measuring inside the solar system."
      },
      {
        q: "What gives Mars its red colour?",
        options: [
          "Red vegetation",
          "Iron oxide — rust — in the surface dust",
          "The way sunlight bends in its atmosphere",
          "Constant volcanic fire"
        ],
        answer: 1,
        why: "Iron oxide. Mars is quite literally rusty: iron in the surface dust has reacted with oxygen over billions of years."
      },
      {
        q: "Which planet has the most confirmed moons?",
        options: ["Jupiter", "Saturn", "Neptune", "Uranus"],
        answer: 1,
        why: "Saturn, with over 270 confirmed. It overtook Jupiter recently — and the number keeps climbing as surveys find smaller ones."
      },
      {
    ...
    questions: [
      {
        ...
        options: [
          "A vast crater",
          "A storm larger than Earth that has raged for centuries",
          "A red desert on the surface",
          "The shadow of a large moon"
        ],
        answer: 1,
        why: "A storm — an anticyclone wide enough to swallow Earth, observed for at least 190 years and probably far longer. It has been visibly shrinking."
      },
      {
        q: "What is a parsec?",
        options: [
          "About 3.26 light-years",
          "The same as one light-year",
          "A unit of time used in space travel",
          "The distance light travels in a second"
        ],
        answer: 0,
        why: "About 3.26 light-years. It comes from parallax: the distance at which a star appears to shift by one arcsecond as Earth orbits."
      },
      {
        q: "What actually powers the Sun?",
        options: [
          "Burning gas, like a fire",
          "Nuclear fusion of hydrogen into helium",
          "Friction from its rotation",
          "Radioactive decay of heavy metals"
        ],
        answer: 1,
        why: "Fusion. Hydrogen nuclei are pressed together into helium, and the tiny difference in mass is released as energy. Burning would have used up the Sun long ago."
      },
      {
        ...
        options: [
          ...
          "The ring of glowing gas around it",
          "The point where time stops entirely"
        ],
        answer: 1,
        why: "A boundary, not a surface — there is nothing physical there. It simply marks where escape would require travelling faster than light."
      },
      {
        q: "What is unusual about Venus's rotation?",
        options: [
          "It does not rotate",
          "It rotates backwards compared with most planets",
          "It rotates faster than any other planet",
          "Its rotation speed changes every year"
        ],
        answer: 1,
        why: "It spins retrograde — backwards — so on Venus the Sun would rise in the west. It also spins so slowly that its day is longer than its year."
      },
      {
        q: "The redshift of distant galaxies is evidence for what?",
        options: [
          "That galaxies are made of red stars",
          "That the universe is expanding",
          "That light slows down over distance",
          "That the galaxies are unusually hot"
        ],
        answer: 1,
        why: "Expansion. Light from receding galaxies is stretched to longer, redder wavelengths — and the further away they are, the faster they recede."
      },
      {
        ...
        options: [
          ...
          "The dust ring around Saturn",
          "A band of comets inside Mercury's orbit"
        ],
        answer: 1,
        why: "A doughnut-shaped region of icy bodies past Neptune. Pluto lives there. The asteroid belt between Mars and Jupiter is a different thing entirely."
      },
      {
        q: "Roughly how long does energy from the Sun's core take to reach its surface?",
    ...
    questions: [
      {
        ...
        options: [
          "Radio noise from distant galaxies",
          "Leftover light from about 380,000 years after the Big Bang",
          "Microwaves given off by the Milky Way's core",
          "Interference from Earth's atmosphere"
        ],
        answer: 1,
        why: "The oldest light there is. When the universe cooled enough for atoms to form, light could finally travel freely — and it is still arriving, stretched into microwaves."
      },
      {
        q: "The Chandrasekhar limit, about 1.4 solar masses, is the maximum mass of what?",
        options: ["A neutron star", "A white dwarf", "A red giant", "A black hole"],
        answer: 1,
        why: "A white dwarf. Above it, electron degeneracy pressure cannot hold the star up and it collapses — which is what triggers a Type Ia supernova."
      },
      {
        q: "What does it mean for a star to be on the main sequence?",
        options: [
          "It is the brightest star in its galaxy",
          "It is fusing hydrogen into helium in its core",
          "It is about to become a supernova",
          "It has no planets orbiting it"
        ],
        answer: 1,
        why: "Core hydrogen fusion. It is the long stable middle of a star's life — the Sun is about halfway through its own roughly 10-billion-year run."
      },
      {
        q: "What does the Hubble constant describe?",
        options: [
          "The mass of the observable universe",
          "The current rate at which the universe is expanding",
          "The brightness of the Hubble Space Telescope's mirror",
          "The maximum age a star can reach"
        ],
        answer: 1,
        why: "The expansion rate. Different measurement methods still disagree on its exact value — an unresolved problem astronomers call the Hubble tension."
      },
      {
        q: "A typical neutron star is roughly what size?",
        options: [
        ...
        answer: 1,
        why: "Around 20 km — a city. It packs more mass than the Sun into that space, so a sugar-cube of it would weigh about as much as a mountain."
      },
      {
        q: "What is stellar parallax used to measure?",
        options: [
          "The temperature of a star",
          "The distance to relatively nearby stars",
          "The chemical make-up of a star",
          "How fast a star is spinning"
        ],
        answer: 1,
        why: "Distance. As Earth moves around the Sun, nearby stars appear to shift slightly against far ones. The size of that shift gives the distance directly."
      },
      {
        q: "What is a star's habitable zone?",
        options: [
          "The region where the star's magnetic field is strongest",
          "The orbital range where liquid water could exist on a surface",
          "The area cleared of asteroids",
          "The zone where the star's light is brightest"
        ],
        answer: 1,
        why: "Where liquid water is possible — sometimes called the Goldilocks zone. It is a rough guide, not a guarantee: atmosphere matters enormously too."
      },
      {
        q: "What triggers a Type Ia supernova?",
        options: [
          "A massive star running out of fuel and collapsing",
          "A white dwarf pulling in enough matter to pass its mass limit",
          "Two neutron stars colliding",
          "A black hole tearing apart a nearby planet"
        ],
        answer: 1,
...
/* Used by main.js to show the rank badge on every page. */
...
(function () {
  ...
  if (!levelGrid) return;                 // not the quiz page
  ...
  /* ---- the rank banner at the top of the page ---- */
  function renderRank() {
    if (progress.rank) {
  ...
  function renderQuestion() {
    ...
    scoreEl.textContent = "Question " + (current + 1) + " of " + level.questions.length +
                          " · score " + score;
  ...
  function choose(i, button) {
    if (answered) return;                 // no changing your mind
    answered = true;
    ...
    /* The explanation shows whether you were right OR wrong. Getting it
       right by luck and getting it right by knowing look identical from
       the outside — the explanation is what tells them apart. */
    explainEl.textContent = item.why;
    explainEl.classList.add("show");

    scoreEl.textContent = "Question " + (current + 1) + " of " + level.questions.length +
                          " · score " + score;
    nextBtn.textContent = current === level.questions.length - 1
      ? "See your result →" : "Next question →";
  ...
  function finish() {
    ...
    var newRank = false;
    if (passed) {
      if (level.id + 1 > progress.unlocked && level.id < QUIZ_LEVELS.length) {
        progress.unlocked = level.id + 1;
      }
      /* Only promote — never demote. A bad retry of an easy level must
         not take away a rank already earned on a harder one. */
    ...
    if (passed && newRank && isFinal) {
      ...
      body = "Top level, cleared. That is the highest rank Cosmos gives, and you earned it on the hardest eight questions here.";
